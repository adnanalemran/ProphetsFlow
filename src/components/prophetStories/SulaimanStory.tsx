                ...
                <section className="my-8 md:my-12">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1">
                            <p className="mb-4">
                                নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>), যাকে ইহুদি-খ্রিস্টান ঐতিহ্যে সলোমন হিসাবে পরিচিত, ছিলেন নবী দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّলَামُ</span>) ১৯ জন পুত্রের মধ্যে একজন। নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّলَামُ</span>) ছিলেন ইসরায়েলের জ্ঞানী রাজা এবং আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) একজন মহান নবী এবং রাসূল।
                            </p>
                            <p className="mb-4">
