                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                <strong className="text-amber-600 dark:text-amber-500">একজন অপেক্ষাকৃত অজানা ব্যক্তি যাকে লোকেরা অবজ্ঞা করত তিনি উঠে দাঁড়িয়েছিলেন এবং নিজেকে কাজের জন্য প্রস্তাব করেছিলেন।</strong> নবী ইয়াসা (<span className="font-arabic">عَلَيْهِ ٱلسَّলَামُ</span>) তাকে জিজ্ঞাসা করেছিলেন যে এই তিনটি শর্ত পূরণ হয়েছে কিনা। লোকটি তিনটির সবকটিতে হ্যাঁ উত্তর দিয়েছিল, কিন্তু ইয়াসা তার দাবিতে বিশ্বাস করেননি এবং যেকোনো কারণে তাকে প্রত্যাখ্যান করেছিলেন।
                            </p>
                        </div>
                    </div>

                    <p className="mb-4">
                        আরও কয়েক দিন কেটে যাওয়ার পর, ইয়াসা (<span className="font-arabic">عَلَيْهِ ٱلسَّলَামُ</span>) আবার দলটিকে একত্রিত করেছিলেন এবং পুনরাবৃত্তি করেছিলেন যে তার শর্তগুলি পূরণ হয়েছে কিনা। <strong>সবাই একই লোকের পাশে বসে রইল।</strong> ইয়াসা, তার অধ্যবসায় দেখে, লোকটিকে তার ডেপুটি হিসাবে কাজ করার জন্য নিয়োগ করেছিলেন।
                    </p>
