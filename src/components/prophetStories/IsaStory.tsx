            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                তার বিস্ময়ের জন্য, প্রতিবার যাকারিয়া (<span className="font-arabic">عَلَيْهِ ٱلسَّলَামُ</span>) মারিয়ামের আশ্রয়ে গিয়েছিলেন, তিনি তাজা ফল পেয়েছিলেন। গ্রীষ্মে জন্মানো ফলগুলো শীতকালে তার ঘরে তাজা পাওয়া যেত, এবং শীতকালে জন্মানো ফলগুলো গ্রীষ্মকালে তার ঘরে তাজা পাওয়া যেত।
                            </p>
                        </div>
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
