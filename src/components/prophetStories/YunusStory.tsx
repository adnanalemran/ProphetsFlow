        ...
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী ইউনুস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>), যাকে কুরআনে যুন-নুন (মাছওয়ালা) হিসাবেও উল্লেখ করা হয়েছে, ছিলেন একজন সম্মানিত নবী যিনি নিনেভেহ শহরের লোকদের কাছে পাঠানো হয়েছিলেন। তিনি ইহুদি-খ্রিস্টান ঐতিহ্যে জোনাহ হিসাবে পরিচিত।
                    </p>
