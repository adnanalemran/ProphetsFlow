        ...
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ছিলেন নবী ইব্রাহিমের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বংশধর। কিছু ইতিহাসবিদ বিশ্বাস করেন যে আইয়ুবের মা ছিলেন নবী লুতের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) কন্যা। তার স্ত্রী, নবী ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সরাসরি বংশধর, নাম ছিল রহমা। একসাথে, তারা রোমে বাস করতেন এবং চৌদ্দ সন্তান দিয়ে আশীর্বাদপ্রাপ্ত হয়েছিলেন।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    <p className="mb-4">
                        <strong>শয়তান (ইবলিস), যিনি কাছে ছিলেন, আলোচনা শুনেছিলেন এবং খুব রাগান্বিত হয়েছিলেন।</strong> তিনি অবিলম্বে আইয়ুবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) উপাসনা থেকে দূরে সরানোর জন্য ষড়যন্ত্র করতে শুরু করেছিলেন। তিনি আইয়ুবের কাছে জীবনের অনেক আনন্দ সম্পর্কে মন্দ চিন্তা ফিসফিস করেছিলেন যা আইয়ুবের মতো একজন মানুষ সহজেই উপভোগ করতে পারে, কিন্তু নবী ছিলেন আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) আন্তরিক বান্দা এবং সহজেই বিচলিত হননি — এটি ইবলিসকে আরও রাগান্বিত করেছিল।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 pt-30 order-1 md:order-2">
                            <p className="mb-4">
                                ইবলিস আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে গিয়েছিলেন এবং তাকে জানিয়েছিলেন যে আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার আন্তরিক বান্দা ছিলেন না এবং কেবল তার সমস্ত সম্পদ হারানোর ভয়ে তাকে মহিমান্বিত করছিলেন।
                            </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                <strong>আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) উত্তর দিয়েছিলেন,</strong><br />
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    ...
                                    <p className="text-sm md:text-base leading-relaxed italic mt-4">
                                        আল্লাহ এখনও জানতেন যে আইয়ুবের বিশ্বাস এবং তার রবের প্রতি ভালোবাসা কমবে না, কিন্তু তিনি আইয়ুবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) আরও পরীক্ষা করতে সম্মত হয়েছিলেন।
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row-reverse gap-4 md:gap-6 my-6">
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
                                ...
                                className="w-full h-auto overflow-hidden rounded-lg object-cover"
                            />
                        </div>
                        <div className="pt-40 flex-1">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        অনেক বছর ধরে, আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার অবস্থার মধ্য দিয়ে ভোগ করতে থাকেন, তার পাশে কেবল রহমা ছিলেন তাকে যত্ন নেওয়ার জন্য। তাদের কোন টাকা ছিল না এবং কোন আয় ছিল না, তাই তার স্ত্রী তাদের জন্য সরবরাহ করার জন্য একটি কাজ নিয়েছিলেন। কিন্তু শহরের লোকেরা রহমাকে দীর্ঘ সময় কাজ করতে দেয়নি, কারণ তারা ভয় করেছিল যে তিনি তার স্বামীর মতো একই অসুস্থতায় তাদের আক্রান্ত করবেন। আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>), এদিকে, এই ব্যথা এবং কষ্ট সহ্য করার জন্য আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে শক্তি এবং ধৈর্য দেওয়ার জন্য প্রার্থনা করতে থাকেন।
                    </p>
                        ...
                        <div className="flex-1">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    ...
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        <strong>আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) দীর্ঘশ্বাস ফেলেছিলেন এবং উত্তর দিয়েছিলেন,</strong><br />
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        <strong>অসহায় বোধ করে, আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে ফিরে গিয়েছিলেন তার রহমত খুঁজছিলেন।</strong>
                                    </p>
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) অবিলম্বে আল্লাহর আদেশ পালন করেছিলেন। <span className="text-amber-600 dark:text-amber-500">তিনি তার পা দিয়ে মাটিতে আঘাত করেছিলেন, ঠান্ডা পানি তার পায়ে প্রবাহিত হয়েছিল।</span> আদেশ অনুযায়ী, আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) পান করেছিলেন এবং পানি ব্যবহার করে তার সমগ্র শরীর ধুয়ে ফেলেছিলেন। অল্প সময়ের মধ্যে, আইয়ুবের ফোস্কা অদৃশ্য হয়ে গিয়েছিল, তার ত্বক সম্পূর্ণরূপে নবায়ন হয়েছিল, এবং তার অভ্যন্তরীণ অঙ্গগুলি কাজ করতে শুরু করেছিল। নিশ্চয়ই, আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) আল্লাহর অনুগ্রহে সম্পূর্ণরূপে সুস্থ হয়েছিলেন!
                    </p>

                    <p className="mb-4">
                        রহমা, যিনি আর তার স্বামী থেকে দূরে থাকতে পারছিলেন না, বাড়িতে ফিরে এসেছিলেন; তিনি তাদের বাড়িতে প্রবেশ করার সময়, আইয়ুবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) দ্বারা স্বাগত জানানো হয়েছিল, যাকে তিনি চিনতে পারেননি।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার স্বাস্থ্য ফিরে পাওয়ার পর তার স্ত্রীকে একশো আঘাত দিয়ে শাস্তি দেওয়ার তার প্রতিশ্রুতি মনে করেছিলেন। তিনি তার প্রিয় স্ত্রীকে আঘাত করতে চাননি, এবং তিনি আল্লাহর কাছে তার শপথ ভাঙতেও চাননি।
                            </p>

                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic">
                                        <strong>তাই, আল্লাহ, সর্বজ্ঞ, আইয়ুবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) নির্দেশ দিয়েছিলেন,</strong><br />
                    ...
                    <p className="mb-4">
                        আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তারপর আইয়ুবের সম্পদ পুনরুদ্ধার করেছিলেন। তিনি সোনার তৈরি পঙ্গপালের বৃষ্টি পাঠিয়েছিলেন যা আইয়ুবের চারপাশে পড়েছিল। আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এই সোনার পঙ্গপাল সংগ্রহ করতে শুরু করেছিলেন,
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>আইয়ুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এবং রহমাকেও তাদের পরিবার ফিরিয়ে দেওয়া হয়েছিল।</strong> দম্পতি আটাশটি সুন্দর, সুস্থ সন্তান দিয়ে আশীর্বাদপ্রাপ্ত হয়েছিলেন — চৌদ্দটি মেয়ে এবং চৌদ্দটি ছেলে।
                    </p>
