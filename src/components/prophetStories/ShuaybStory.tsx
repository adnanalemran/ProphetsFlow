        ...
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            ...
                            <p className="mb-4">
                                <strong>তাদের সূরা কাফ আয়াত ১৪-এ <em>আসহাব আল-আইকাহ</em> বা <span className="text-amber-600 dark:text-amber-500">"কাঠের সঙ্গী"</span> হিসাবে উল্লেখ করা হয়েছে।</strong> তাদের দুর্নীতি এবং অবিশ্বাসের প্রতিক্রিয়ায়, আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তাদের নিজস্ব সম্প্রদায় থেকে একজন নবী নিয়োগ করে পথনির্দেশ পাঠিয়ে তার রহমত প্রদান করেছিলেন। তিনি শুআইব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) নামক একজন ব্যক্তিকে এই গুরুত্বপূর্ণ কাজের জন্য নির্বাচন করেছিলেন।
                            </p>
                        </div>
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী শুআইব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার লোকদের সম্বোধন করেছিলেন, তাদের মিথ্যা দেবতাদের ত্যাগ করতে এবং একমাত্র আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) উপাসনা করার জন্য অনুরোধ করেছিলেন।
                    </p>
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        নবী শুআইব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার লোকদের তাদের ব্যবসায়িক লেনদেনে ন্যায়সঙ্গত এবং ন্যায়পরায়ণ হতে এবং তাদের জীবিকা সৎভাবে উপার্জন করতে অনুরোধ করেছিলেন।
                    </p>
                    ...
                    <p className="mb-4">
                        সূরা আশ-শুআরা, আয়াত ১৭৭-১৮৪-এ, নবী শুআইব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার লোকদের ধার্মিকতার জন্য একটি অনুরূপ অনুরোধ ভাগ করেছেন এবং আল্লাহকে ভয় করার গুরুত্বের উপর জোর দিয়েছেন।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        <strong>অবিশ্বাসীরা, পরিবর্তন করতে অনিচ্ছুক এবং লোভে ভরা, নবী শুআইবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) উপহাস করেছিল তারা বিদ্রূপে উত্তর দিয়েছিল,</strong>
                                    </p>
                                    <p className="text-sm md:text-base leading-relaxed italic">
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        তাই, তাদের বিবেক জাগ্রত করার প্রচেষ্টায়, তিনি তাদের মনে করিয়ে দিয়েছিলেন যে নবী নূহ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>), হুদ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>), এবং সালিহ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) লোকদের যে শেষ হয়েছিল এবং তাদের অনুরোধ করেছিলেন যে তারা আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) আন্তরিক ক্ষমা চাইতে।
                    </p>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>শুআইব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ধৈর্যশীল ছিলেন যখন তিনি উত্তর দিয়েছিলেন:</strong><br />
                ...
                <section className="my-8 md:my-12">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                হুমকি দ্বারা নিরুৎসাহিত না হয়ে, শুআইব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তাদের পূর্বপুরুষদের ধর্ম ত্যাগ করতে এবং আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) ধর্ম প্রচার করতে থাকেন। তার অধ্যবসায় মাদইয়ানের নেতাদের রাগান্বিত করেছিল কারণ তারা শুআইবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) কাছ থেকে কোন অবকাশ দেখেনি।
                            </p>

                            <p className="mb-4">
                                নেতারা, গোত্রের মধ্যে তাদের মর্যাদা এবং কর্তৃত্ব হারানোর ভয়ে, শুআইবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এবং তার অনুসারীদের তাদের বিশ্বাস প্রচার করতে চ্যালেঞ্জ ছাড়াই অনুমতি দেওয়ার ঝুঁকি বুঝতে পেরেছিলেন।
                            </p>
                        </div>
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>নবী (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) উত্তর দিয়েছিলেন:</strong><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                <strong>নেতারাও শুআইবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) অনুসারীদের লক্ষ্য করেছিলেন এবং হুমকি দিয়েছিলেন:</strong><br />
                    ...
                    <p className="mb-4">
                        ভয়ে যে আরও অনেকেই শুআইবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাথে যোগ দেবে, নেতারা শুআইবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) জিনিসপত্র এবং তার অনুসারীদের জিনিসপত্র আটকে রেখেছিল এবং তাদের মাদইয়ান থেকে বের করে দিয়েছিল। তাই নবী তার রবের কাছে প্রার্থনা করেছিলেন এবং তার সাহায্যের জন্য অনুরোধ করেছিলেন।
                    </p>
                </section>
