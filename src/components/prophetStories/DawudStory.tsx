        ...
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        এই সাহসী যুবক ছিলেন অন্য কেউ নন দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>), বেথলেহেম শহর থেকে।
                    </p>
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        ...
                        <em>"আমি তোমার সাহসের প্রশংসা করি, কিন্তু তুমি সেই শক্তিশালী যোদ্ধার সাথে মিল নেই। অভিজ্ঞ যোদ্ধারা আসুক,"</em> তিনি দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) বলেছিলেন।
                    </p>
                    ...
                    <p className="mb-4">
                        দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) আরও অনুরোধ করেছিলেন তার রাজাকে তার চেহারা অনুযায়ী তাকে বিচার না করতে এবং তাকে আশ্বস্ত করেছিলেন যে তিনি কোনো মানুষ বা বন্য প্রাণীকে ভয় করেন না।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row-reverse gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1">
                            <p className="mb-4">
                                রাজা নিজেই যোদ্ধাকে যুদ্ধের জন্য প্রস্তুত করার দায়িত্ব নিয়েছিলেন। তিনি দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) যুদ্ধের বর্ম পরিয়েছিলেন এবং তার হাতে একটি তরোয়াল রেখেছিলেন।
                            </p>
                            <p className="mb-4">
                                কিন্তু দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) তার নিজের উপায়ে কাজ করতে অভ্যস্ত ছিলেন। তিনি অনুভব করেছিলেন যে যুদ্ধের বর্ম তার চলাচলকে সীমাবদ্ধ করছে, তাই তিনি এটি সরিয়ে ফেলেছিলেন, তার তরোয়ালের সাথে।
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                <strong>কেবলমাত্র <span className="text-amber-600 dark:text-amber-500">কয়েকটি নুড়ি একটি চামড়ার থলিতে</span> কাঁধে ঝুলানো, <span className="text-amber-600 dark:text-amber-500">একটি স্লিং</span>, এবং <span className="text-amber-600 dark:text-amber-500">একটি কাঠের লাঠি</span> দিয়ে, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) দৈত্যের মুখোমুখি হওয়ার জন্য প্রস্তুত ছিলেন।</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>তালুত, উদ্বেগে ভরা, দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) প্রশ্ন করেছিলেন:</strong><br />
                                <em>"তুমি কীভাবে একটি স্লিং এবং কয়েকটি পাথর দিয়ে একটি দৈত্যের বিরুদ্ধে নিজেকে রক্ষা করবে?"</em>
                            </p>
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>উত্তরে, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) নিশ্চিত করেছিলেন:</strong><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                <strong>দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) চিৎকার করে উত্তর দিয়েছিলেন:</strong><br />
                    ...
                    <p className="mb-4">
                        এইভাবে, সর্বশক্তিমান আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) সাহায্যে, ইসরায়েলীরা তাদের শত্রুদের উপর বিজয় অর্জন করেছিল এবং তাদের মর্যাদা পুনরুদ্ধার করেছিল। <strong>এবং রাতারাতি, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) একজন সম্মানিত নায়কের মর্যাদায় আরোহণ করেছিলেন।</strong>
                    </p>

                    <p className="mb-4">
                        তার কথা সম্মান করে, রাজা তালুত তার কন্যার সাথে দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) বিবাহ দিয়েছিলেন এবং তাকে একজন প্রধান উপদেষ্টা হিসাবে নিয়োগ করেছিলেন। এইভাবে, দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) রাজত্বের পথ প্রশস্ত হয়েছিল।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        দৈত্যের উপর অলৌকিক বিজয়ের পর, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) একাকীত্ব খুঁজতে মরুভূমিতে বের হয়েছিলেন দিনের ঘটনাগুলি প্রতিফলিত করতে এবং আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কে মহিমান্বিত করতে। দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) ছিলেন আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) একজন নম্র বান্দা যিনি গর্বকে তার হৃদয়ে প্রবেশ করতে দেননি এবং সর্বশক্তিমানকে ভুলে যাননি।
                    </p>

                    <p className="mb-4">
                        <strong>এই সময়ে আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) নবুওয়ত দান করেছিলেন।</strong> রব দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) অনেক অলৌকিক ঘটনা দিয়েছিলেন যা তার আগে বা পরে কোনো নবীকে দেওয়া হয়নি।
                    </p>
                    ...
                    <p className="mb-4">
                        আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তার রাসূল দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) প্রাণীদের সাথে কথোপকথন করার ক্ষমতাও দান করেছিলেন।
                    </p>

                    <p className="mb-4">
                        নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) ছিলেন তার রবের (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) একজন ধর্মপরায়ণ উপাসক। তিনি কখনই তার বক্তব্য বা কাজে আল্লাহকে (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) মহিমান্বিত করার সুযোগ হারাননি।
                    </p>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic">
                                ...
                                <em>"আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে সবচেয়ে প্রিয় রোজা ছিল নবী দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) রোজা যিনি বিকল্প দিনে রোজা রাখতেন। এবং আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে সবচেয়ে প্রিয় প্রার্থনা ছিল দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) প্রার্থনা যিনি রাতের (প্রথম) অর্ধেক ঘুমাতেন এবং এর এক তৃতীয়াংশ প্রার্থনা করতেন এবং (আবার) এর এক ষষ্ঠাংশ ঘুমাতেন।"</em><br />
                    ...
                    <p className="mb-4">
                        নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) যুদ্ধে একটি গুরুত্বপূর্ণ এবং প্রভাবশালী ব্যক্তিত্ব হয়ে উঠেছিলেন; তিনি এ সম্পর্কিত বিষয়গুলিতে ব্যাপকভাবে পরামর্শ নিতেন।
                    </p>

                    <p className="mb-4">
                        একদিন, কিছু সৈন্য নবী দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) কাছে এসেছিল এবং অভিযোগ করেছিল যে তাদের লোহার বর্ম খুব ভারী এবং যুদ্ধের সময় তাদের চলাচলকে মারাত্মকভাবে সীমাবদ্ধ করছে।
                    </p>

                    <p className="mb-4">
                        নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) একদিন লোহার একটি টুকরো নিয়ে খেলতে খেলতে এই সমস্যাটি নিয়ে চিন্তা করছিলেন যখন হঠাৎ, তার বড় বিস্ময়ের জন্য, তার আঙুল লোহার মধ্য দিয়ে ডুবে গিয়েছিল। <strong>আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তাকে আরেকটি উপহার দিয়েছিলেন – <span className="text-amber-600 dark:text-amber-500">লোহা গঠন করার ক্ষমতা।</span></strong>
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَٰمُ</span>) তার সাহস, ধার্মিকতা এবং জ্ঞানের জন্য রাজ্য জুড়ে ব্যাপকভাবে প্রশংসিত এবং প্রশংসিত হয়েছিলেন। মানুষের চোখে, তিনি এমনকি রাজা তালুতকেও ছাড়িয়ে গিয়েছিলেন। জনমতের এই পরিবর্তন রাজার নজর এড়ায়নি।
                    </p>

                    <p className="mb-4">
                        একদিন, নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) তার শ্বশুরকে দুঃখে দেখেছিলেন এবং তার মনোভাবের পার্থক্য অনুভব করেছিলেন। উদ্বিগ্ন হয়ে, তিনি তার স্ত্রী মিখালের সাথে তার চিন্তা ভাগ করেছিলেন, যিনি অবিলম্বে কান্না শুরু করেছিলেন এবং দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) ক্রমবর্ধমান জনপ্রিয়তার প্রতি তার বাবার ঈর্ষা প্রকাশ করেছিলেন। <span className="text-amber-600 dark:text-amber-500">মিখাল তার স্বামীকে সর্বদা সতর্ক থাকতে সতর্ক করেছিলেন, তার বাবার ঈর্ষা থেকে সম্ভাব্য ক্ষতির ভয়ে।</span>
                    </p>

                    <p className="mb-4">
                        দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَٰمُ</span>) ছিলেন একজন ধর্মপরায়ণ এবং আন্তরিক মানুষ, তালুতের ঈর্ষার খবরে গভীরভাবে বিচলিত। তিনি প্রার্থনা করেছিলেন যে তালুতের হৃদয় ঈর্ষা থেকে মুক্ত হবে এবং সে তার পূর্ববর্তী সদগুণ প্রকৃতিতে ফিরে আসবে।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                পরের দিন, তালুত দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) জানিয়েছিলেন যে তাদের শত্রু, কানান, তার বাহিনী একত্রিত করেছিল এবং তালুতের রাজ্যকে উৎখাত করার জন্য তার উপর মার্চ করার পরিকল্পনা করছিল।
                            </p>
                            <p className="mb-4">
                                <strong>তিনি দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) কানান এবং তার লোকদের সাথে যুদ্ধ করতে এবং বিজয় অর্জন না করা পর্যন্ত ফিরে না আসতে নির্দেশ দিয়েছিলেন।</strong>
                            </p>
                        </div>
                    </div>

                    <p className="mb-4">
                        দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) ছিলেন বিচক্ষণ, এই নির্দেশে তার মৃত্যুর জন্য একটি সম্ভাব্য ফাঁদ অনুভব করেছিলেন—শত্রুর আক্রমণ বা তালুতের লোকদের বিশ্বাসঘাতকতার ভয়ে। <strong>তার সন্দেহ সত্ত্বেও, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) তার জীবনকে আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) হাতে রেখেছিলেন এবং নির্দেশ অনুযায়ী এগিয়ে গিয়েছিলেন।</strong> তার সেনাবাহিনী শত্রু সেনাদের সাথে দেখা করেছিল এবং সাহসের সাথে যুদ্ধ করেছিল, বিজয়ী হয়ে উঠেছিল। দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) অক্ষত অবস্থায় রাজ্যে ফিরে এসেছিলেন।
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>সেই রাতেই, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) প্রয়োজনীয় সরবরাহ সংগ্রহ করেছিলেন এবং তালুতের রাজ্য থেকে পালিয়ে গিয়েছিলেন, <span className="text-amber-600 dark:text-amber-500">যেখানে তিনি কয়েক দিন একটি গুহায় লুকিয়ে ছিলেন।</span></strong>
                    </p>
                    ...
                    <p className="mb-4">
                        দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) চলে যাওয়ার পর, তালুত আক্রমণাত্মকভাবে তার হারানো ক্ষমতা একত্রিত করার চেষ্টা করেছিল। তিনি একজন একনায়কের মতো তার রাজ্য শাসন করতে শুরু করেছিলেন। তিনি শিক্ষিতদের নিপীড়ন করেছিলেন, যারা তালমুদ পালন করত তাদের নিপীড়ন করেছিলেন, এবং তার সেনাবাহিনীকে সন্ত্রাস করেছিলেন। এটি মানুষের সাথে তার জনপ্রিয়তাকে আরও ক্ষয় করেছিল। ক্রুদ্ধ হয়ে, তালুত দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) সাথে যুদ্ধ করার সিদ্ধান্ত নিয়েছিল। তাই, তার সেনাবাহিনী সংগ্রহ করে, তালুত তার জামাইয়ের সাথে যুদ্ধ করতে তার রাজ্য ছেড়ে চলে গিয়েছিল।
                    </p>

                    <p className="mb-4">
                        দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) আসন্ন সেনাবাহিনীর খবর পেয়েছিলেন এবং তাদের মুখোমুখি হওয়ার সিদ্ধান্ত নিয়েছিলেন। তিনি আবিষ্কার করেছিলেন যে তালুতের সেনাবাহিনী বাড়ি থেকে অনেক দূরে একটি উপত্যকায় বিশ্রাম করছে।
                    </p>
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        গোপনে, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) তালুতের শিবিরের দিকে তার পথ তৈরি করেছিলেন এবং তাকে ঘুমন্ত অবস্থায় পেয়েছিলেন। <span className="text-amber-600 dark:text-amber-500">দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) তার তরোয়াল সরিয়ে ফেলেছিলেন এবং তালুতের পোশাকের একটি টুকরো কেটে ফেলেছিলেন।</span>
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic">
                                        <strong>দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَاমُ</span>) তালুতকে জাগিয়েছিলেন এবং বলেছিলেন:</strong><br />
                                        <em>"ওহে রাজা, তুমি আমাকে খুঁজতে বেরিয়েছ, কিন্তু আমি তোমাকে ঘৃণা করি না, এবং আমি তোমাকে হত্যা করতে চাই না। যদি আমি করতাম, আমি তোমাকে হত্যা করতাম যখন তুমি ঘুমিয়েছিলে।এখানে 	তোমার 	পোশাকের 	একটি 	টুকরো। 	আমি 	এর 	পরিবর্তে 	তোমার 	ঘাড় 	কেটে 	ফেলতে 	পারতাম, 	কিন্তু 	আমি 	করিনি। <strong>আমার 	মিশন 	হল 	প্রেমের, 	দুষ্টতার 	নয়।</strong>"</em>
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
                    ...
                    <p className="mb-4">
                        তালুত তখন তার বোধে ফিরে এসেছিল, তার কাজের বিশালতা উপলব্ধি করে, এবং নবী দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) কাছে ক্ষমা চেয়েছিল।
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) ছিলেন একজন ন্যায়পরায়ণ, নম্র এবং ধার্মিক রাজা যার শাসন রাজ্যে শান্তি এবং সমৃদ্ধি নিশ্চিত করেছিল। রাজা হিসাবে তার নতুন ভূমিকা সত্ত্বেও, দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) ধর্ম প্রচারের তার দায়িত্বে অবহেলা করেননি। যাবুরের তার মধুর আবৃত্তি যারা শুনেছিল তাদের সবাইকে মুগ্ধ করেছিল, কেবল মানুষই নয়, পাখি, প্রাণী এবং গাছগুলিকেও আকর্ষণ করেছিল, এর ঐশ্বরিক আয়াত দিয়ে শ্রোতাদের মুগ্ধ করেছিল।
                    </p>

                    <p className="mb-4">
                        একজন রাজা এবং একজন নবীর ভূমিকার ভারসাম্য করা কোনো সহজ কাজ ছিল না। কিন্তু দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) ছিলেন নিবেদিত এবং সংকল্পের সাথে দায়িত্ব গ্রহণ করেছিলেন। তিনি তার কোনো দায়িত্বে পিছিয়ে পড়েননি এবং তার দিনকে চার ভাগে ভাগ করেছিলেন:
                    </p>
                    ...
                    <p className="mb-4">
                        নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) তার অনুপস্থিতিতে মানুষের সমস্যাগুলি দেখাশোনা করার জন্য ডেপুটিদের ক্ষমতাও দিয়েছিলেন।
                    </p>

                    <p className="mb-4">
                        আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) রাজত্বকে আশীর্বাদ করেছিলেন। তার রাজ্য ছিল দাউদের যোগ্যতার একটি প্রমাণ। তিনি তার শত্রুদের দ্বারাও ব্যাপকভাবে ভীত ছিলেন।
                    </p>

                    <p className="mb-4">
                        রাজা হিসাবে তার রাজকীয় মর্যাদা সত্ত্বেও, নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) তার আয়ের জন্য রাজ্যের উপর নির্ভর করেননি। তার জীবিকা নিজের দ্বারা তৈরি অস্ত্র বিক্রি করে সুরক্ষিত ছিল।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            ...
                            <p className="mb-4">
                                দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>), বিস্মিত হয়ে, তার শান্তি ফিরে পাওয়ার চেষ্টা করেছিলেন এবং লোকদের তাদের অভিযোগ ব্যাখ্যা করতে বলেছিলেন।
                            </p>
                    ...
                    <p className="mb-4">
                        কিছু কুরআন ব্যাখ্যাকারীরা তওবার জন্য সিজদায় পড়ে যাওয়ার গল্পটিকে বাইবেলে পাওয়া অপরাধবোধের গল্পের সাথে সংযুক্ত করে। কিন্তু সঠিক বোঝাপড়া হল যে নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) ভয় করেছিলেন যে তিনি ন্যায়বিচার করেননি। তিনি দুজন লোকের মধ্যে অকালে বিচার করেছিলেন এবং সমস্ত দৃষ্টিভঙ্গি বিবেচনা করতে ব্যর্থ হয়েছিলেন।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) জ্ঞান এবং সঠিক বিচার কেবল নবী দাউদকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) নয়, তার প্রিয় পুত্র সুলাইমানকেও (আল্লাহর শান্তি তার উপর বর্ষিত হোক) দান করেছিলেন।
                    </p>

                    <p className="mb-4">
                        বর্ণিত আছে যে একদিন, যখন নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) তার লোকদের সমস্যাগুলি শুনছিলেন সুলাইমানের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) সাথে, যিনি তখন এগারো বছর বয়সী ছিলেন, দুজন লোক তার কাছে এসেছিল।
                    </p>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic">
                                নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) তারপর রায় দিয়েছিলেন:<br />
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        <strong>সেই মুহূর্তে, নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) এগিয়ে এসেছিলেন, একটি বিকল্প দৃষ্টিভঙ্গি প্রদান করেছিলেন। তিনি পরামর্শ দিয়েছিলেন,</strong><br />
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic">
                                <strong>তার পুত্রের বুদ্ধিমত্তায় মুগ্ধ হয়ে,<br /> দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) মন্তব্য করেছিলেন,</strong><br />
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) ছিলেন আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) সবচেয়ে প্রভাবশালী নবীদের মধ্যে একজন যিনি তার শেষ নিঃশ্বাস পর্যন্ত তাকে ধর্মপরায়ণভাবে উপাসনা করেছিলেন। তাকে একজন নবী হিসাবে পাঠানো হয়েছিল, কারণ ইসরায়েলের লোকদের নবী মুসা (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) এবং হারুনের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) মৃত্যুর পর একজন পথনির্দেশকের প্রয়োজন ছিল।
                    </p>

                    <p className="mb-4">
                        <strong>নবী দাউদের আকস্মিক মৃত্যু হাজার হাজার লোক শোক করেছিল, যার মধ্যে চার হাজার পুরোহিত ছিল।</strong> তার মৃত্যুর দিন, তীব্র তাপ বিরাজ করছিল। নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) - যিনি প্রাণীদের সাথে কথোপকথন করার ক্ষমতা দিয়ে উপহার পেয়েছিলেন - পাখিদকে ডেকেছিলেন শোককারীদের প্রখর সূর্য থেকে রক্ষা করতে যতক্ষণ না দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) সমাহিত হয়েছিল।
                    </p>
