        ...
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        তিনি নবী আদমের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) জীবদ্দশায় জন্মগ্রহণ করেছিলেন। বিশ্বাস করা হয় যে তিনি শীথের অনুসারীদের মধ্যে ছিলেন এবং শীথের মৃত্যুর পর আদমের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) বংশধরদের শাসন করেছিলেন।
                    </p>

                    <p className="mb-4">
                        ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) ছিলেন আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) আন্তরিক বান্দা। তাই, আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তাঁকে নবী এবং রাসূল হিসেবে নির্বাচিত করেছিলেন এবং আদমের সন্তানদের উপর শাসক হিসেবে নির্বাচিত করেছিলেন।
                    </p>

                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                শীথের মৃত্যুর পর যা শুরু হয়েছিল তা হল কাবিল (কাবিল) এর লোকেরা পথনির্দেশ হারিয়ে ফেলেছিল, এবং পাপ ও দুর্নীতি দ্রুত বৃদ্ধি পেতে শুরু করেছিল এবং ছড়িয়ে পড়েছিল। ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) তাঁর নিজের লোকদের শয়তানের প্রভাবের শিকার হতে দেখতে পারছিলেন না।
                            </p>
                        </div>
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
                ...
                <section className="my-8 md:my-12">
                    <h2 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 dark:text-white border-l-4 border-amber-500 pl-4">
                        নবী ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) <span className="text-amber-600 dark:text-amber-500">সীমালঙ্ঘনকারীদের উপর বিজয়:</span>
                    </h2>

                    <p className="mb-4">
                        আহলে কিতাবের একটি বর্ণনা থেকে, যা অনেক কুরআন ব্যাখ্যাকারও উল্লেখ করেছেন, এবং আল্লাহ সর্বোত্তম জানেন — একদিন, নবী ইদ্রিসকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) একটি অসাধারণ প্রতিশ্রুতি সম্পর্কে জানিয়েছিলেন। তাঁকে বলা হয়েছিল যে তিনি প্রতিটি মানুষের শেষ নিঃশ্বাস পর্যন্ত সম্পাদিত সমস্ত ভাল কাজের পুরস্কার পাবেন। এর অর্থ হল তিনি দ্বিগুণ পুরস্কার পাবেন।
                    </p>

                    <p className="mb-4">
                        নবী ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) এই সংবাদে অত্যন্ত আনন্দিত হয়েছিলেন এবং আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে তাঁর সমস্ত আশীর্বাদের জন্য অত্যন্ত কৃতজ্ঞতা প্রকাশ করেছিলেন। কিন্তু ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) বেশ বয়স্ক ছিলেন, এবং তিনি জানতেন যে মৃত্যু নিকটবর্তী। তিনি এই পৃথিবী থেকে চলে যেতে প্রস্তুত ছিলেন না কারণ তিনি পৃথিবীতে ভালোতা ছড়াতে উপভোগ করতেন। তাঁর ফেরেশতাদের মধ্যে একজন বন্ধু ছিলেন যাকে তিনি জিজ্ঞাসা করেছিলেন যে তিনি মৃত্যুর ফেরেশতার সাথে কথা বলতে পারেন কিনা এবং দেখতে পারেন যে এটি বিলম্বিত করা যায় কিনা। ফেরেশতা তাঁকে বলেছিলেন যে এটি আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) সাথে একটি বিষয় কিন্তু চেষ্টা করতে কোনও ক্ষতি নেই। এইভাবে, ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) ফেরেশতার ডানায় উঠে স্বর্গে আরোহণ করেছিলেন। তিনি প্রথম, দ্বিতীয় এবং তৃতীয় স্বর্গের মধ্য দিয়ে গিয়েছিলেন। যাইহোক, চতুর্থ স্তরে পৌঁছানোর পর, আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) মৃত্যুর ফেরেশতাকে তাঁর জীবন গ্রহণ করতে নির্দেশ দিয়েছিলেন।
                    </p>
                    ...
                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500 font-semibold">ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) বিতর্ক করেননি</span>; তিনি কেবল স্বীকার করেছিলেন যে যদি এটি আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) নির্ধারিত হয়, তবে তাই হোক।
                    </p>
                    ...
                    <p className="mb-4">
                        নবী ইদ্রিসের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) এই অসাধারণ ঘটনাটি সহিহ বুখারি হাদিস নম্বর ৭৫১৭ এবং আত-তিরমিযি ৩১৫৭-এ উল্লিখিত হিসাবে নিশ্চিত করা হয়েছে। যখন নবী মুহাম্মদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) ইসরা এবং মিরাজ (রাতের যাত্রা) এর সময় স্বর্গে আরোহণ করেছিলেন, তিনি তাঁর আগে আসা বিভিন্ন নবীদের দ্বারা অভিবাদন পেয়েছিলেন। প্রথম স্বর্গে, তিনি আদমের সাথে দেখা করেছিলেন; দ্বিতীয়তে, ঈসা এবং ইয়াহইয়ার সাথে; তৃতীয়তে, ইউসুফের সাথে; এবং চতুর্থতে, ইদ্রিসের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) সাথে (তাদের সকলের উপর শান্তি বর্ষিত হোক)।
                    </p>

                    <p className="mb-4">
                        এই প্রসঙ্গটি সেই আয়াতটিতে গভীর অর্থ আনে যেখানে আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) বলেন যে ইদ্রিস (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) উচ্চ মর্যাদায় উন্নীত হয়েছিলেন। এই উন্নতি কেবল তাঁর নৈতিক চরিত্র এবং ধার্মিকতাকে বোঝায় না বরং তাঁর আক্ষরিক আরোহণকেও বোঝায়, যেখানে তাঁকে চতুর্থ স্বর্গে নিয়ে যাওয়া হয়েছিল।
                    </p>

                    <p className="mb-4">
                        নবী ইদ্রিসের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) মৃত্যুর পর, দুর্নীতি আবার দ্রুত বৃদ্ধি পেতে শুরু করেছিল। কয়েক প্রজন্ম পরে, কোনও নবুওয়তের নির্দেশনা ছাড়াই, শয়তান আদমের সন্তানদের প্রভাবিত করতে সফল হয়েছিল তাদের প্রথম শিরক (বহুঈশ্বরবাদ) কাজ করতে।
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    <h2 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 dark:text-white border-l-4 border-amber-500 pl-4">
                        নবী ইদ্রিসের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) <span className="text-amber-600 dark:text-amber-500">শিক্ষা:</span>
                    </h2>
