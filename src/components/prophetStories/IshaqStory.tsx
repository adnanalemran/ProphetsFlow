                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                নবী ইব্রাহিম (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) এবং তার প্রথম স্ত্রী সারাহ একসাথে বৃদ্ধ এবং সাদা চুলের হয়ে গিয়েছিলেন।
                            </p>
                            <p className="mb-4">
                                একদিন, তাদের তিনজন দর্শক ছিল। যেমন সেই সময়ে আরবদের জন্য প্রথাগত ছিল, নবী ইব্রাহিম (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) তিনজন পুরুষকে খাবারের জন্য আমন্ত্রণ করেছিলেন।
                            </p>
                        </div>
                    </div>
