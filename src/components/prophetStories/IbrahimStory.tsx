            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                ইব্রাহিম (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) জানতেন যে তাকে বিচারের জন্য ডাকা হবে, কিন্তু তিনি ভয় পাননি। তিনি ইতিমধ্যে জানতেন কীভাবে গ্রামবাসীদের বোকা বানাতে হয় যাতে তাদের দেখানো যায় যে তারা ভুল পথে রয়েছে। ইব্রাহিম (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) এও জানতেন যে যদি তার ক্ষতি হতে হয়, তাহলে তা আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) অনুমতিতে হতে হবে।
                            </p>
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                    ...
                    <p className="mb-4">
                        কিন্তু অহংকার আবার তাদের মনে মেঘ সৃষ্টি করেছিল। তারা স্বীকার করতে পারেনি যে তারা অন্ধ ছিল; তাই তারা নিজেদের বিপরীত করেছিল এবং ইব্রাহিমের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَামُ</span>) সাথে আবার তর্ক করেছিল: "তুমি ইতিমধ্যে জান যে এগুলি কথা বলে না!" (সূরা আল-আনবিয়া, আয়াত ৬৫)
                    </p>
