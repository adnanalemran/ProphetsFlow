        ...
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        তার সততা এবং সত্যবাদিতা আল-আজিজের হৃদয়কে মুগ্ধ করেছিল, যিনি ইউসুফকে (<span className="font-arabic">عَلَيْهِ السَّلَامُ</span>) তার পরিবারের দায়িত্বে রাখার জন্য বিশ্বাস করেছিলেন। এই সময়কালে ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّলَামُ</span>) তার দ্বিতীয় পরীক্ষার সম্মুখীন হয়েছিলেন। জুলাইখা, আল-আজিজের স্ত্রী, দিনের পর দিন ইউসুফকে দেখেছিলেন, তার অনুভূতি অবসেশনের পর্যায়ে তীব্র হয়ে উঠেছিল। তার ইচ্ছা দ্বারা অভিভূত হয়ে, তিনি তাদের পূরণ করতে হতাশ হয়ে পড়েছিলেন।
                    </p>
