    ...
    return (
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className=" my-8 md:my-12">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="w-full bg-accent md:w-1/3 flex-shrink-0 order-2 md:order-1">
                            <img 
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        তার সততা এবং সত্যবাদিতা আল-আজিজের হৃদয়কে মুগ্ধ করেছিল, যিনি ইউসুফকে (<span className="font-arabic">عَلَيْهِ السَّلَامُ</span>) তার পরিবারের দায়িত্বে রাখার জন্য বিশ্বাস করেছিলেন। এই সময়কালে ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার দ্বিতীয় পরীক্ষার সম্মুখীন হয়েছিলেন। জুলাইখা, আল-আজিজের স্ত্রী, দিনের পর দিন ইউসুফকে দেখেছিলেন, তার অনুভূতি অবসেশনের পর্যায়ে তীব্র হয়ে উঠেছিল। তার ইচ্ছা দ্বারা অভিভূত হয়ে, তিনি তাদের পূরণ করতে হতাশ হয়ে পড়েছিলেন।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        <strong>ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>), আল্লাহকে (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) ভয় করে, উত্তর দিয়েছিলেন,</strong><br />
                                    ...
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        <strong>ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) হতবাক হয়েছিলেন। তিনি তার মালিকের দাবি অস্বীকার করতে থাকেন, বলছেন,</strong><br />
                    ...
                    <p className="mb-4">
                        এইভাবে, ইউসুফের নির্দোষতা প্রমাণিত হয়েছিল। আল-আজিজ তার স্ত্রীর অশ্লীলতার জন্য ক্ষমা চেয়েছিলেন এবং ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) গোপনীয়তার শপথ করিয়েছিলেন।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                যখন মহিলারা ফল কাটার সময় আনন্দে চ্যাট করছিল, জুলাইখা ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ডাকলেন। মহিলারা তাকে দেখলেন। এমন দেবদূতীয় সৌন্দর্যে বিস্মিত হয়ে, তারা বুঝতে পারেনি যে তারা তাদের হাত কেটে ফেলেছিল। জুলাইখা মুহূর্তটি কাজে লাগিয়ে ঘোষণা করেছিলেন যে এই ব্যক্তির জন্যই তাকে দোষ দেওয়া হয়েছিল।
                            </p>
                        </div>
                    </div>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                তিনি তারপর ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সতর্ক করেছিলেন যে যদি তিনি আবার তাকে অস্বীকার করেন, তাহলে তাকে কারাগারে রাখা হবে,
                            </p>
                            <p className="text-sm md:text-base leading-relaxed italic">
                    ...
                    <p className="mb-4">
                        সেই রাতে, জুলাইখা তার স্বামীকে বোঝালেন যে তার সম্মান এবং তার মর্যাদা রক্ষা করার একমাত্র উপায় হল ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) কারাগারে রাখা। এটি আল-আজিজের জন্য একটি কঠিন সিদ্ধান্ত ছিল। তিনি ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) নির্দোষতা জানতেন এবং তাকে বিশ্বাসযোগ্য বলে বিশ্বাস করেছিলেন, কিন্তু তবুও, তিনি তার স্ত্রীর সাথে সম্মত হয়েছিলেন। <strong><span className="text-amber-600 dark:text-amber-500">এইভাবে, ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) অন্যায়ভাবে কারাগারে রাখা হয়েছিল।</span></strong>
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    <h2 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 dark:text-white border-l-4 border-amber-500 pl-4 text-center">
                        <span className="text-amber-600 dark:text-amber-500">ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>)</span> কারাগারে বছরগুলো:
                    </h2>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        <strong>ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) প্রথমে তাদের আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে ডেকেছিলেন, তারপর ব্যাখ্যা করেছিলেন,</strong>
                                    </p>
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                    ...
                                    <p className="text-sm md:text-base leading-relaxed italic">
                                        <strong className="text-amber-600 dark:text-amber-500">কিন্তু শয়তান তাকে ভুলিয়ে দিয়েছিল</strong> তার মালিকের কাছে [উল্লেখ] এবং ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) কয়েক বছর ধরে কারাগারে রয়ে গিয়েছিলেন। তবুও, তিনি ধৈর্যকে তার নিজের করেছিলেন এবং সেই বছরগুলো আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) স্মরণে কাটিয়েছিলেন।
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        পানপাত্রবাহক, যিনি অবিলম্বে কারাগারে তার সঙ্গীকে মনে করেছিলেন, রাজাকে ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এবং তার নিখুঁত স্বপ্ন ব্যাখ্যা সম্পর্কে জানিয়েছিলেন। রাজা তার পানপাত্রবাহককে কারাগারে পাঠিয়েছিলেন ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাথে দেখা করতে এবং এই অদ্ভুত স্বপ্ন সম্পর্কে জিজ্ঞাসা করতে।
                    </p>

                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার সঙ্গীকে দেখে অত্যন্ত আনন্দিত হয়েছিলেন এবং জানতেন যে এটি নিশ্চয়ই আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) পরিকল্পনা ছিল।
                            </p>
                            <p className="text-sm md:text-base leading-relaxed italic">
                    ...
                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500">নবী ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>),</span> স্বপ্নের ভিত্তিতে, বুঝতে পেরেছিলেন যে সাত বছরে একটি দুর্ভিক্ষ আসবে যা সাত বছর স্থায়ী হবে। তিনি রাজাকে অবিলম্বে পদক্ষেপ নিতে পরামর্শ দিয়েছিলেন ফসল কাটা এবং প্রচুর খাদ্য সরবরাহ সংরক্ষণ শুরু করতে। ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) পরামর্শ দিয়েছিলেন যে এই প্রস্তুতি সবার জন্য পর্যাপ্ত খাদ্য নিশ্চিত করার জন্য গুরুত্বপূর্ণ হবে। তদুপরি, তিনি সুসংবাদ দিয়েছিলেন যে পরের বছরটি হবে প্রাচুর্যের বছর। আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) বৃষ্টি আনবেন যা ফসলকে সমৃদ্ধ করতে দেবে।
                    </p>

                    <p className="mb-4">
                        ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) স্বপ্ন ব্যাখ্যায় বিশ্বাস করে, রাজা তাকে ব্যক্তিগতভাবে দেখা করার নির্দেশ দিয়েছিলেন। যাইহোক, ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার নির্দোষতা প্রতিষ্ঠিত হওয়ার আগে কারাগার ছেড়ে যেতে অস্বীকার করেছিলেন। তিনি তার সম্মান রক্ষার জন্য একটি ন্যায়সঙ্গত বিচার জোর দিয়েছিলেন।
                    </p>
                    ...
                    <p className="mb-4">
                        <strong className="text-amber-600 dark:text-amber-500">এইভাবে, ইউসুফের নির্দোষতা প্রমাণিত হয়েছিল।</strong> কারাগার থেকে মুক্তি পেয়ে, ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) রাজার সামনে দাঁড়িয়েছিলেন তার উদারতার জন্য ধন্যবাদ জানাতে। ইউসুফ রাজাকে অত্যন্ত মুগ্ধ করেছিলেন; তার স্বাধীনতা হারানোর পর এবং অনেক বছর ধরে মিথ্যা কারাগারে থাকার পর, তিনি রাগান্বিত ছিলেন না, প্রতিশোধ চাইছিলেন না। তিনি শান্ত ছিলেন এবং সবচেয়ে মহৎ গুণাবলী দেখিয়েছিলেন। এর কারণে, রাজা ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) একটি উচ্চ পদে নিয়োগ করতে স্বাচ্ছন্দ্য বোধ করেছিলেন।
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    <p className="mb-4">
                        ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) জিজ্ঞাসা করেছিলেন যে তাকে তার জমির উপর গুদামগুলির দোকানদার করা যেতে পারে কিনা। তিনি শস্যভাণ্ডারের উপর নিয়ন্ত্রক হতে চেয়েছিলেন যাতে নিশ্চিত করা যায় যে তারা দীর্ঘ দুর্ভিক্ষ সহ্য করার জন্য ভালোভাবে সজ্জিত ছিল। এটি স্বার্থপরতা থেকে নয় বরং একটি ব্যক্তিগত দায়িত্ব যা তিনি অনুভব করেছিলেন যাতে নিশ্চিত করা যায় যে লোকেরা ঘাটতির কারণে মারা যাবে না।
                    </p>

                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500">ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাত বছর উর্বরতার সময় ফসল সংগ্রহ এবং সংরক্ষণ করেছিলেন।</span> তারপর, যেমন ভবিষ্যদ্বাণী করা হয়েছিল, দুর্ভিক্ষের বছরগুলো এসেছিল যা কানানে তার পিতা ইয়াকুবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) পরিবারেও পৌঁছেছিল। ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বিনইয়ামিন ছাড়া তার সমস্ত পুত্রকে সরবরাহ কেনার জন্য মিশরে পাঠিয়েছিলেন।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) অবিলম্বে তার ভাইদের চিনতে পেরেছিলেন এবং তাদের সরবরাহ করেছিলেন, কিন্তু তারা তাকে চিনতে পারেনি। এবং কেন তারা করবে? তাদের কাছে, ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বছর আগে মারা গিয়েছিলেন।
                            </p>
                        </div>
                    </div>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাধারণভাবে তাদের পরিবার সম্পর্কে জিজ্ঞাসা করেছিলেন।
                            </p>
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                হঠাৎ আবেগের তাড়নায়, ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) চোখে অশ্রু জমা হয়েছিল, তার হৃদয় ভারী হয়ে বাড়িতে তার পিতা এবং ছোট ভাইকে দেখার জন্য আকাঙ্ক্ষা করছিল।
                            </p>
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                    ...
                    <p className="mb-4">
                        ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তাদের জানিয়েছিলেন যে যদি তারা পরের বার তাদের ভাইকে নিয়ে আসে, তাহলে তিনি তাদের দ্বিগুণ রেশন দিয়ে পুরস্কৃত করবেন। কিন্তু যদি তারা তা করতে ব্যর্থ হয়, তাহলে তিনি তাদের পরিমাণ সীমিত করবেন।
                    </p>

                    <p className="mb-4">
                        তিনি নিশ্চিত করতে চেয়েছিলেন যে তারা তার আদেশ পালন করবে। একটি অতিরিক্ত সতর্কতা হিসাবে, ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার একজন চাকরকে তাদের টাকা তাদের ব্যাগে ফিরিয়ে দেওয়ার নির্দেশ দিয়েছিলেন যাতে তারা বাড়িতে ফিরে আসার পর, তাদের ফিরে আসার এবং আরও কেনার জন্য যথেষ্ট টাকা থাকবে।
                    </p>
                    ...
                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500">ইয়াকুব রাগান্বিত হয়েছিলেন।</span> ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাথে তাকে ভয়াবহভাবে ব্যর্থ করার পর তিনি কীভাবে তাদের বিশ্বাস করতে পারেন? কিছু সময় পর, যাইহোক, তাদের প্রয়োজনের চাপ ইয়াকুবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) আরও সরবরাহের জন্য বিনইয়ামিনকে তাদের সাথে পাঠাতে বাধ্য করেছিল। তিনি তাদের গুরুতর শপথ নিয়েছিলেন তাকে রক্ষা করার জন্য।
                    </p>

                    <p className="mb-4">
                        ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তারপর তাদের প্রস্থান রক্ষা করার জন্য আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছে প্রার্থনা করেছিলেন,
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বিশেষ অতিথিদের স্বাগত জানিয়েছিলেন এবং তাদের একটি ভোজে আমন্ত্রণ করেছিলেন। অত্যন্ত কষ্ট সহকারে, তিনি অবিলম্বে তার ভাইকে আলিঙ্গন করা থেকে বিরত ছিলেন। ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার অতিথিদের তার উপহার এবং আতিথেয়তা দিয়ে স্নান করেছিলেন। পরে, ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বিনইয়ামিনকে তার সাথে একা একটি ঘরে থাকার ব্যবস্থা করেছিলেন যেখানে তিনি প্রকাশ করেছিলেন, "নিশ্চয়ই, আমি তোমার ভাই।" (১২:৬৯)
                    </p>
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        <strong>তারা ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তাকে আশ্বস্ত করার চেষ্টা করার আগে একটু কেঁদেছিল,</strong><br />
                    ...
                    <p className="mb-4">
                        শক এবং অবিশ্বাস ভাইদের আঘাত করেছিল; বাড়িতে তাদের অসুস্থ পিতার চিন্তা এবং যে কোনও মূল্যে বিনইয়ামিনকে রক্ষা করার তাদের প্রতিশ্রুতি তাদের মনে ঘুরছিল। ভাইয়েরা জানত যে তাদের পিতা বিনইয়ামিনকে খুব বেশি ভালোবাসতেন, এবং তিনি ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) হারানোর পর থেকে একটি উপশমের মাধ্যম ছিলেন। তারা উদ্বিগ্ন ছিল যে বিনইয়ামিনের ক্ষতি তাদের পিতাকে সম্পূর্ণরূপে বিধ্বস্ত করবে।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        যখন তারা বাড়িতে ফিরে এসেছিল, তারা ইয়াকুবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) খবর দিয়েছিল, <em>"হে আমাদের পিতা, নিশ্চয়ই তোমার পুত্র চুরি করেছে, এবং আমরা যা জানতাম তা ছাড়া সাক্ষ্য দিইনি। এবং আমরা অদৃশ্যের সাক্ষী ছিলাম না, এবং যে শহরে আমরা ছিলাম এবং যে কাফেলায় আমরা এসেছিলাম তা জিজ্ঞাসা কর – এবং নিশ্চয়ই, আমরা সত্যবাদী"</em> (১২:৮১-৮২)
                    </p>

                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500">নবী ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) একটি সত্য বিশ্বাসীর অনুগ্রহ সহকারে গুরুতর পরিস্থিতির মুখোমুখি হয়েছিলেন।</span> কোনও শান্তি খুঁজতে, তিনি প্রার্থনার দিকে ফিরে গিয়েছিলেন, আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) পরিকল্পনায় তার বিশ্বাস রেখেছিলেন: <em>"সম্ভবত আল্লাহ তাদের সবাইকে আমার কাছে নিয়ে আসবেন। নিশ্চয়ই তিনিই সর্বজ্ঞ, সর্বজ্ঞ।"</em> (১২:৮৩) তিনি আশা করেছিলেন তার কনিষ্ঠ এবং জ্যেষ্ঠ পুত্রদের নিরাপদ প্রত্যাবর্তনের জন্য, যারা মিশরে আটকে ছিল। তবুও, এই নতুন ক্ষতি ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) জন্য তার স্থায়ী শোককে পুনরুজ্জীবিত করেছিল। দুঃখে মুখ ফিরিয়ে, তিনি কেঁদেছিলেন, <em>"ওহ, ইউসুফের জন্য আমার দুঃখ।"</em> (১২:৮৪)
                    </p>
                    ...
                    <p className="mb-4">
                        তার অবস্থা এত খারাপ হয়ে গিয়েছিল যে ভাইয়েরা তার স্বাস্থ্য নিয়ে উদ্বিগ্ন হতে শুরু করেছিল; তারা ইয়াকুবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সতর্ক করেছিল,
                    </p>
                    ...
                    <p className="mb-4">
                        তার অটলতায়, ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার পুত্রদের বলেছিলেন, <em>"আমি কেবল আমার কষ্ট এবং আমার দুঃখের অভিযোগ আল্লাহর কাছে করি, এবং আমি আল্লাহর কাছ থেকে জানি যা তোমরা জানো না।"</em> (১২:৮৬)। ভাষ্যকাররা বিশ্বাস করেন যে এই লাইনটি বলার সময়, "আমি আল্লাহর কাছ থেকে জানি যা তোমরা জানো না," ছিল আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছ থেকে ভালোর প্রতি তার বিশ্বাস প্রকাশ করছিল। তিনি আশা করেন যে ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এখনও জীবিত এবং তিনি যখন ছোট ছিলেন তখন তাকে যে দর্শন বলেছিলেন তা এখনও সত্য হবে।
                    </p>

                    <p className="mb-4">
                        ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তারপর উত্তর দিয়েছিলেন, <em>"হে আমার পুত্রেরা, যাও এবং ইউসুফ এবং তার ভাই সম্পর্কে খুঁজে বের কর এবং আল্লাহর কাছ থেকে উপশমের আশা হারিও না। নিশ্চয়ই, কেউ আল্লাহর কাছ থেকে উপশমের আশা হারায় না কেবল অবিশ্বাসী লোকেরা।"</em> (১২:৮৭)
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        পুত্ররা আবার মিশরে ফিরে এসেছিল। তারা ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাথে দেখা করেছিল এবং অনুরোধ করেছিল যে তাদের উপর একটি ট্র্যাজেডি ঘটেছে।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        <strong>ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তারপর তাদের মাতৃভাষায় তাদের সাথে কথা বলেছিলেন,</strong><br />
                                    ...
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        ভাইদের বুঝতে বেশি সময় লাগেনি যে এটি নিশ্চয়ই তাদের দীর্ঘ-হারানো ভাই, এবং তারা ভয়ে কাঁপতে শুরু করেছিল। কিন্তু ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তাদের সান্ত্বনা দিয়েছিলেন, বলছেন,
                                    </p>
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                    ...
                    <p className="mb-4">
                        আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) ফরমানের একটি সুন্দর পরিপূর্ণতায়, সূরা, যা ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) নবুওয়তের স্বপ্ন দিয়ে শুরু হয়েছিল, সেই বিন্দুতে পৌঁছেছে যেখানে এটি একটি বাস্তবতা হয়ে ওঠে।
                    </p>

                    <p className="mb-4">
                        ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার সৃষ্টিকর্তার কাছে একটি দুআ করে, তার সমস্ত আশীর্বাদের জন্য ধন্যবাদ জানাচ্ছেন।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তিক্ত হতে এবং আল্লাহকে (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) জিজ্ঞাসা করতে বেছে নিতে পারতেন,</strong>
                            </p>
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                    ...
                    <p className="mb-4">
                        <span className="font-medium">ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার সেরা হতে ফোকাস করেছিলেন, লোকদের সঠিকভাবে আচরণ করেছিলেন, সম্মান এবং মর্যাদার সাথে, এবং তার কাছ থেকে যা চাওয়া হয়েছিল তার চেয়ে বেশি করেছিলেন। যদি তিনি তার অংশ করতেন, তিনি জানতেন যে আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তার যত্ন নেবেন। তাকে একটি শিশু হিসাবে নিয়ে যাওয়া হয়েছিল এবং তার পরিবার না জেনে বড় হয়েছিলেন। এবং এই প্রতিকূলতা সত্ত্বেও, তিনি একটি মহৎ মর্যাদার মানুষ হয়ে উঠেছিলেন, যারা তার সাথে দেখা করেছিল তাদের দ্বারা সম্মানিত, আল-আজিজ থেকে মহিলাদের যারা তাদের হাত কেটেছিল এবং রাজা পর্যন্ত - তারা সবাই ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) উৎকৃষ্ট গুণাবলীর জন্য প্রশংসা করেছিল। এটি একটি শিক্ষা যে পরিস্থিতি মানুষ তৈরি করে না। তারা কেবল তাকে নিজের কাছে প্রকাশ করে।</span>
                    </p>

                    <p className="mb-4">
                        এটিও উল্লেখযোগ্য যে নবী ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) গল্প কুরআনে একটি অনন্য স্থান ধারণ করে। তিনি একমাত্র নবী যার গল্প একটি একক সূরা, "সূরা ইউসুফ" শিরোনামে কালানুক্রমিকভাবে বলা হয়েছে। অন্যান্য নবীদের গল্পের সাথে এর বিপরীতে, যা বিভিন্ন সূরায় উল্লিখিত এবং একসাথে জোড়া লাগানোর প্রয়োজন। আমরা পাঠকদের দৃঢ়ভাবে সুপারিশ করি যে তারা সূরা ইউসুফের অনুবাদ শুনুন এবং অনুসরণ করুন, কারণ এটি সুন্দরভাবে নবী ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) যাত্রার সম্পূর্ণতা বর্ণনা করে।
                    </p>
