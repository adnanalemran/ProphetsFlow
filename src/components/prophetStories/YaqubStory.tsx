            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        ইসলামী সাহিত্যে উল্লিখিত নবী ইয়াকুবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) গল্প প্রায়ই নবী ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) গল্পের সাথে জড়িত।
                    </p>

                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500">কুরআন</span> নবী ইসহাকের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এবং, পরবর্তীতে, ইয়াকুবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) জীবনের বিবরণে গভীরভাবে যায় না। তাই, ইয়াকুবের প্রাথমিক জীবন সম্পর্কে যা জানা যায় তা প্রায়ই নির্ভরযোগ্য কুরআন ভাষ্যকারদের দ্বারা কিতাবের লোকদের কাছ থেকে অভিযোজিত হয়।
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বারো পুত্রের পিতা ছিলেন। প্রথম দশজন তার প্রথম স্ত্রীর কাছে জন্মগ্রহণ করেছিলেন, যখন নবী ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এবং তার ভাই বিনইয়ামিন তার দ্বিতীয় স্ত্রীর কাছে জন্মগ্রহণ করেছিলেন। বারো পুত্র বনু ইসরায়েলের মূল বারো গোত্র গঠন করেছিল।
                    </p>
                    ...
                    <p className="mb-4">
                        এই আয়াত থেকে, এটি ইয়াকুবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বংশধরদের উল্লেখ করে, তার বারো সন্তানকে নির্দেশ করে। ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) মিশরে প্রধানমন্ত্রী হয়ে ওঠার পর, তার সমগ্র পরিবার সেখানে চলে গিয়েছিল। তারা সেখানে শান্তিপূর্ণভাবে অনেক প্রজন্ম ধরে বাস করেছিল যতক্ষণ না তারা একজন ফেরাউনের অত্যাচারের অধীনে পড়েছিল। এখানে, তারা অনেক কষ্ট ভোগ করেছিল। নবী মুসা (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) আসার পরই তারা মুক্তি পেয়েছিল।
                    </p>
                            ...
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                        ইসরায়েলের সন্তানদের পালাতে সাহায্য করার পর, মুসা (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) একটি অলৌকিক ঘটনা করেছিলেন,<br /><br />
                ...
                <section className="my-8 md:my-12">
                    <h2 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 dark:text-white border-l-4 border-amber-500 pl-4 text-center">
                        <span className="text-amber-600 dark:text-amber-500">ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>)</span>-এর কুরআনে গল্প
                    </h2>

                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic">
                                <strong><span className="text-amber-600 dark:text-amber-500">যখন ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এখনও একটি ছোট ছেলে ছিলেন</span>, তিনি এক সকালে জেগে উঠেছিলেন এবং তার পিতাকে একটি স্বপ্ন বর্ণনা করেছিলেন যা তিনি দেখেছিলেন।</strong><br />
                    ...
                    <p className="mb-4">
                        নবী ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>), স্বপ্ন ব্যাখ্যা করার ক্ষমতা দিয়ে আশীর্বাদপ্রাপ্ত, অপরিমেয় আনন্দে অভিভূত হয়েছিলেন। তিনি বুঝতে পেরেছিলেন যে স্বপ্নটি ছিল আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছ থেকে একটি নিদর্শন যে তিনি ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) একটি বিশেষ উদ্দেশ্যে নির্বাচন করেছিলেন, যা তার উত্তরাধিকার অব্যাহত রাখা এবং নবুওয়তে তার উত্তরসূরি হওয়া। স্বপ্নে, এটি বিশ্বাস করা হয় যে এগারোটি তারকা তার ভাইদের প্রতীক, এবং সূর্য এবং চাঁদ তার পিতামাতা।
                    </p>

                    <p className="mb-4">
                        ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ভাইদের প্রতিক্রিয়াও নিয়ে উদ্বিগ্ন ছিলেন, কারণ যদিও ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তাদের সমানভাবে আচরণ করেছিলেন, তারা ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) প্রতি ঈর্ষান্বিত বোধ করত। তিনি জানতেন যে ঈর্ষা একটি দুষ্ট আবেগ যা গুরুতর ক্ষতি করার ক্ষমতা রাখে। তাই তিনি ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার ভাইদের কাছে তার স্বপ্ন সম্পর্কে বলতে সতর্ক করেছিলেন।
                    </p>

                    <p className="mb-4">
                        ইয়াকুবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) প্রচেষ্টা সত্ত্বেও, ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বিরুদ্ধে তার পুত্রদের হৃদয়ে বিদ্বেষ বছরের পর বছর ধরে বেড়ে উঠেছিল। একদিন, তার বড় পুত্ররা ইয়াকুবের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) কাছে এসেছিলেন এবং প্রস্তাব করেছিলেন যে তিনি ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তাদের সাথে একটি বেড়াতে যেতে অনুমতি দেন।
                    </p>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) অনিচ্ছুক ছিলেন।</strong><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                ...
                                <strong>যেমন ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ভয় করেছিলেন, ভাইরা বেড়াতের সন্ধ্যায় কান্নাকাটি করে ফিরে এসেছিলেন।</strong><br />
                                <em>"আমাদের পিতা! আমরা দৌড়াচ্ছিলাম এবং ইউসুফকে আমাদের জিনিসপত্রের সাথে রেখে গিয়েছিলাম, এবং একটি নেকড়ে তাকে খেয়ে ফেলেছে! কিন্তু আপনি আমাদের বিশ্বাস করবেন না, আমরা যতই সত্যবাদী হই না কেন,"</em> তারা দাবি করেছিল, ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) রক্ত-দাগযুক্ত এবং ছেঁড়া শার্ট উপস্থাপন করে।
                            </p>
                        </CardContent>
                    </Card>

                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500">ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বুঝতে পেরেছিলেন যে তার পুত্ররা শয়তানের কানফুঁসিতে সমর্পণ করেছিল।</span> তিনি জানতেন যে তারা ইচ্ছাকৃতভাবে তাদের ভাই ইউসুফকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ক্ষতি করেছিল। কিন্তু ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এও বিশ্বাস করেছিলেন যে ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) এখনও জীবিত ছিল এবং আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তাকে রক্ষা করছিলেন। <em>"না! তোমাদের আত্মা অবশ্যই তোমাদের কিছু মন্দ করতে প্রলুব্ধ করেছে,"</em> তিনি রাগান্বিত হয়েছিলেন। <em>"তাই আমি কেবল সহ্য করতে পারি <strong>(ফা সাবরুন জামিল)</strong> সুন্দর ধৈর্য! এটি আল্লাহর সাহায্য যা আমি তোমাদের দাবি সহ্য করার জন্য চাই।"</em>
                    </p>
                ...
                <section className="my-8 md:my-12">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                মিশর এবং প্রতিবেশী অঞ্চলগুলিতে একটি ভয়াবহ দুর্ভিক্ষ আঘাত করেছিল। নবী ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার পুত্রদের নির্দেশ দিয়েছিলেন, বিনইয়ামিন ছাড়া, সরবরাহ নিশ্চিত করার জন্য মিশরে রাজার প্রাসাদে ভ্রমণ করতে। তাদের ফিরে আসার পর, তারা তাদের পিতাকে জানিয়েছিল যে রাজার প্রাসাদের দোকানদার তাদের আরও সরবরাহ দিতে অস্বীকার করেছিল যদি তারা তাদের কনিষ্ঠ ভাইকে নিয়ে ফিরে না আসে।
                            </p>
                        </div>
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) খবরে সন্তুষ্ট ছিলেন না। ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাথে তাকে হতাশ করার পর তিনি কীভাবে আবার তাদের বিশ্বাস করতে পারেন?<br /><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong><span className="text-amber-600 dark:text-amber-500">ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>)</span> আবার সম্মত হতে বাধ্য হয়েছিলেন। কিন্তু তিনি দাবি করেছিলেন:</strong><br />
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        পুত্ররা আবার গুরুতর খবর নিয়ে ফিরে এসেছিল। তারা তাদের পিতাকে জানিয়েছিল যে কনিষ্ঠ, বিনইয়ামিন, চুরির অভিযোগে অভিযুক্ত হয়েছিল এবং মিশরে আটক ছিল। <span className="text-amber-600 dark:text-amber-500">ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) রাগান্বিত হয়েছিলেন।</span>
                    </p>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                <strong className="text-amber-600 dark:text-amber-500">ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) উত্তর দিয়েছিলেন,</strong><br />
                ...
                <section className="my-8 md:my-12">
                    <h2 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 dark:text-white border-l-4 border-amber-500 pl-4 text-center">
                        <span className="text-amber-600 dark:text-amber-500">ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>)</span>-এর সুন্দর শিক্ষা
                    </h2>

                    <p className="mb-4">
                        <span className="text-amber-600 dark:text-amber-500">এ সম্পর্কে সবচেয়ে প্রশংসনীয় বিষয় হল ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) চ্যালেঞ্জিং পরিস্থিতিতে কীভাবে প্রতিক্রিয়া দেখিয়েছিলেন।</span> দুর্দশার সময়ে, তিনি আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) দিকে ফিরে গিয়েছিলেন, বাক্যাংশটি মূর্ত করে, (فَصَبۡرٞ جَمِيلٞۖ) 'ফা সাবরুন জামিল', যার অর্থ "সুন্দর ধৈর্য"। এটি একটি বিশেষ ধরনের ধৈর্য যা একটি ইতিবাচক দৃষ্টিভঙ্গি বজায় রাখা এবং আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) পরিকল্পনায় অটল বিশ্বাস দ্বারা চিহ্নিত, বিশেষ করে কঠিন সময়ে।
                    </p>
                    ...
                    <p className="mb-4">
                        উদাহরণস্বরূপ, ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ভাইদের দ্বারা বিশ্বাসঘাতকতা এবং পরবর্তী কষ্ট অবশেষে রাজার জন্য কাজ করার এবং অসংখ্য জীবন বাঁচানোর তার ভূমিকায় নেতৃত্ব দিয়েছিল। আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰىٰ</span>) উপায়গুলি নিশ্চয়ই রহস্যময় এবং সর্বদা সর্বোত্তম, এমনকি যদি সেগুলি আমাদের কাছে অবিলম্বে স্পষ্ট না হয়।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    <h2 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 dark:text-white border-l-4 border-amber-500 pl-4 text-center">
                        <span className="text-amber-600 dark:text-amber-500">ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>)</span> তার পুত্রের সাথে পুনর্মিলিত
                    </h2>

                    <p className="mb-4">
                        ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তারপর তার পুত্রদের নির্দেশ দিয়েছিলেন যে তারা আবার যাবে এবং তাদের উভয় ভাইকে খুঁজবে।
                    </p>
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>শীঘ্রই, নবী ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>), তার হারানো পুত্রের জন্য তার শোকে অন্ধ হয়ে, তার চারপাশের লোকদের জানিয়েছিলেন:</strong><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                যখন তার পুত্ররা আবার ফিরে এসেছিল, তারা তাদের পিতার মুখের উপর একটি শার্ট ফেলে দিয়েছিল। <strong className="text-amber-600 dark:text-amber-500">আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) অলৌকিক ঘটনায়, ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার দৃষ্টিশক্তি ফিরে পেয়েছিলেন।</strong> এটি ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) শার্ট ছিল, রাজার প্রাসাদের দোকানদার!
                            </p>
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>অত্যধিক আনন্দিত হয়ে, ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তার সন্তানদের জানিয়েছিলেন:</strong><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mb-4">
                                <strong>তার সন্তানেরা ইয়াকুবকে (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) অনুরোধ করেছিল:</strong><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                <strong>ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) বলেছিলেন,</strong><br />
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic mt-4">
                                তাই পুত্ররা তাদের আগ্রহী পিতাকে মিশরে নিয়ে গিয়েছিল তার প্রিয় পুত্র এবং নবী ইউসুফের (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) সাথে পুনর্মিলিত করতে।
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <p className="mb-4">
                        <strong>তার পরিবার গ্রহণ করার পর, ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) ঘোষণা করেছিলেন:</strong><br />
                    ...
                    <p className="mb-4">
                        ইউসুফ (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) তারপর তার পিতাকে সিংহাসনে তুলেছিলেন এবং বলেছিলেন,
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী ইয়াকুব (<span className="font-arabic">عَلَيْهِ ٱلسَّ</span>) মারা যাওয়ার আগে, তিনি তার পুত্রদের একটি চূড়ান্ত প্রশ্ন করেছিলেন।
                    </p>
