        ...
        <div className="mb-12 mt-6 md:mt-10">
            ...
            <div className="prose prose-sm md:prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-justify space-y-6 md:space-y-8">
                ...
                <section className="my-8 md:my-12">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1">
                            <p className="mb-4">
                                নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ السَّلَامُ</span>), যাকে ইহুদি-খ্রিস্টান ঐতিহ্যে সলোমন হিসাবে পরিচিত, ছিলেন নবী দাউদের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) ১৯ জন পুত্রের মধ্যে একজন। নবী দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) ছিলেন ইসরায়েলের জ্ঞানী রাজা এবং আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) একজন মহান নবী এবং রাসূল।
                            </p>
                            <p className="mb-4">
                                তাই, যখন দাউদ (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) মারা গিয়েছিলেন, তিনি সুলাইমান দ্বারা উত্তরসূরি হয়েছিলেন, যাকে আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তার বাবার নবুওয়তের উত্তরাধিকার বহন করার জন্য নির্বাচিত করেছিলেন। <strong>তাকে অনেক উপহার দেওয়া হয়েছিল এবং তিনি ইসরায়েলি জাতির উপর একজন ন্যায়পরায়ণ এবং জ্ঞানী শাসক হিসাবে রয়ে গিয়েছিলেন।</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <p className="mb-4">
                        সহীহ বুখারী ৬৭২৫-এ একটি বর্ণনায়, আল্লাহর রাসূল (<span className="font-arabic">ﷺ</span>) বলেছেন,<br /> <em className="text-amber-600 dark:text-amber-500">'আমাদের সম্পত্তি (অর্থাৎ নবীদের বস্তুগত সম্পত্তি) উত্তরাধিকারসূত্রে পাওয়া যায় না, এবং আমরা যা রেখে যাই তা দান-খয়রাতে ব্যয় করতে হবে।</em>"<br /><br /> বরং, নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) যা উত্তরাধিকারসূত্রে পেয়েছিলেন তা ছিল তার বাবার আধিপত্য এবং জ্ঞান।<em className="text-amber-600 dark:text-amber-500"> "নিশ্চয়ই উলামা (পণ্ডিতরা) নবীদের উত্তরাধিকারী, এবং নবীরা দীনার বা দিরহাম রেখে যান না।"</em> (জামি আত-তিরমিজি ২৬৮২)
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) এই দুনিয়ায় অনেক সাফল্য এবং সুখ উপভোগ করেছিলেন।
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) যেভাবে আশীর্বাদপ্রাপ্ত হয়েছিলেন <span className="text-amber-600 dark:text-amber-500">সব উপায় বর্ণনা করার সময়,</span> তিনি যেভাবে প্রতিক্রিয়া দেখান তা অসাধারণ।</strong> ক্ষমতা এবং সাফল্য তার পদে থাকা বেশিরভাগ মানুষকে দুর্নীতিগ্রস্ত করবে।
                    </p>
                    ...
                    <p className="mb-4">
                        ফেরাউনকে আধিপত্য এবং শাসন দেওয়া হয়েছিল, কিন্তু তার অজ্ঞতা তাকে একটি ভিন্ন পথে গঠন করেছিল। <strong>এটিকে নবী সুলাইমানের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) সাথে তুলনা করুন, যার চরিত্র সঠিক জ্ঞানের উপর নির্মিত হয়েছিল, যা একটি সম্পূর্ণ ভিন্ন ফলাফলের দিকে নিয়ে যায়।</strong>
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <p className="mb-4">
                                <strong>যদিও কাগজে, মনে হয় যে নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) এর কাছে সবকিছু ছিল, এটি প্রতিকূলতা বা পরীক্ষা ছাড়া ছিল না।</strong> আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কুরআনে বলেছেন যে আমরা সুলাইমানকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) পরীক্ষা করেছি। তার সম্পদ এবং রাজত্ব একটি আশীর্বাদ মনে হতে পারে, কিন্তু সত্যিই, এটি আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) কাছ থেকে একটি কঠিন পরীক্ষা। এই অবস্থানে কতজন মনে করবে যে তারা লটারি জিতেছে কিন্তু, হিসাবের দিনে, বুঝতে পারবে যে এটি তাদের ঈমানের (বিশ্বাস) জন্য সবচেয়ে খারাপ জিনিস ছিল?
                            </p>

                            <p className="mb-4">
                                নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) একজন নেতা এবং একজন নবী হিসাবে অনেক দায়িত্ব বহন করেছিলেন। প্রথম, এবং সবচেয়ে গুরুত্বপূর্ণ, আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) একজন বান্দা হওয়ার কারণে, তিনি ক্রমাগত যিকির এবং আল্লাহর স্মরণে নিযুক্ত ছিলেন। কুরআন তাকে প্রশংসা করে বলছে, "এবং আমরা দাউদকে সুলাইমান দিয়ে আশীর্বাদ করেছিলাম। তিনি ছিলেন একজন উৎকৃষ্ট বান্দা। নিশ্চয়ই, তিনি (আমাদের দিকে, অনুতাপ এবং প্রশংসায়) ফিরে আসায় মহান ছিলেন"<br />
                    ...
                    <p className="mb-4">
                        নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) (ٱلْخَيْرِ) <strong><em className="text-amber-600 dark:text-amber-500">আল-খায়র</em></strong> এর প্রতি তার ভালবাসা দ্বারা মুহূর্তের জন্য বিভ্রান্ত হয়ে পড়েছিলেন যাকে <strong className="text-amber-600 dark:text-amber-500">ভাল জিনিসের ভালবাসা</strong> হিসাবে অনুবাদ করা হয়েছে, এই ক্ষেত্রে, তার ঘোড়া। আয়াতটি অব্যাহত রয়েছে, "যতক্ষণ না <em>এটি</em> পর্দার পিছনে চলে গিয়েছিল," এবং এখানে, <em>'এটি'</em> ভাষ্যকারদের দ্বারা বোঝা যায় যে সূর্য দিগন্তের পিছনে অস্ত যাওয়া বোঝায়। তাই, নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) অনিচ্ছাকৃতভাবে আসরের নামাজের সময় হারিয়ে ফেলেছিলেন। এটি ইচ্ছাকৃত ছিল না বরং ভুলে যাওয়ার কারণে।
                    </p>

                    <p className="mb-4">
                        এছাড়াও, এই জিনিসগুলির প্রতি তার ভালবাসার প্রকাশ অহংকারে মূলবদ্ধ ছিল না। আয়াতটি যেমন স্পষ্ট করে, <strong className="text-amber-600 dark:text-amber-500"><em>"আমার রবের স্মরণের কারণে।"</em></strong> সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) সবকিছুতেই আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) ভালবাসা খুঁজে পেয়েছিলেন, কেবল একজন পর্যবেক্ষক হিসাবে সব সৃষ্টিতে আল্লাহর মহিমা এবং মহত্ত্ব দেখছিলেন।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                তিনি চলে যাওয়া ঘোড়াগুলিকে ফিরিয়ে ডেকেছিলেন এবং তাদের ঘাড় এবং পায়ের উপর তার হাত ঘষেছিলেন। এখন, এখানে মতপার্থক্য রয়েছে। কিছু ভাষ্যকার বলেছেন যে আরবি শব্দ (مَسْحًۢا) <em className="text-amber-600 dark:text-amber-500">মাশান</em>, এর অর্থ <strong className="text-amber-600 dark:text-amber-500">তরোয়াল দিয়ে আঘাত করা</strong>। এটি পরামর্শ দেয় যে নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) স্মরণ অবহেলা করার পর, তিনি নিজের উপর একটি শাস্তি আরোপ করেছিলেন।
                            </p>
                            <p className="mb-4">
                    ...
                    <p className="mb-4">
                        যাইহোক, এগুলি প্রায়ই উদ্ভাবিত গল্প এবং আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) নবীকে অসম্মান করে। এর সাথে, নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) যে পরীক্ষার মধ্য দিয়ে গিয়েছিলেন তা নিশ্চিতভাবে বোঝা কঠিন। আমাদের কৌতূহল আমাদের একটি উত্তর তৈরি করতে চায়, এবং তাই এটি এই ঘটনার অনেক কল্পনাপ্রসূত উদ্ভাবনের দিকে নিয়ে গেছে।
                    </p>

                    <p className="mb-4">
                        <strong>ইবনে কাথিরের পদ্ধতি আরও উপযুক্ত, <span className="text-amber-600 dark:text-amber-500">কুরআন যা অস্পষ্ট রেখেছে তা যেমন আছে তেমনই রেখে দেওয়া উচিত, এর বিশদ বিবরণে খনন না করে।</span></strong> আমাদের জন্য আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) এবং তার রাসূল যা উল্লেখ করেছেন তার বাইরে আরও বিশদ জানতে না চাওয়া ভাল। আমরা যা সংগ্রহ করতে পারি তা হল যে নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) আবারও পরীক্ষা করা হয়েছিল, এবং এটি তাকে আরও বেশি ভক্তির অনুভূতি সহ আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) দিকে ফিরিয়ে দিয়েছিল।
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        এই ঘটনার পর, নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) নিম্নলিখিত দুআ করেছিলেন বলে রেকর্ড করা হয়েছে:
                    </p>
                    ...
                    <p className="mb-4">
                        যেকোনো নবীর লক্ষ্য হল নিজেকে বস্তুগত এবং পার্থিব জীবনের সাথে উদ্বিগ্ন না করা। নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) ক্ষমতা-সন্ধানের জন্য শুধু অন্য কোনো রাজত্ব চান না। এটি লক্ষ্য করে স্পষ্ট করা হয়েছে যে তিনি কীভাবে দুআ শুরু করেন। তার হৃদয় এবং মনে, তিনি তার আত্মাকে শুদ্ধ করে শুরু করেন, ক্ষমা চেয়ে। তার উদ্বেগ এই দুনিয়ার নয় বরং আখিরাত দিয়ে শুরু হয়। তদুপরি, আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তার নবীকে জানেন, তিনি জানেন সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) সব স্বার্থপর ইচ্ছা থেকে মুক্ত ছিলেন এবং তার কাজে ভালত্ব ছড়িয়ে দেওয়ার জন্য এই সম্পদ চেয়েছিলেন।
                    </p>
                    ...
                    <p className="mb-4 text-center text-sm italic">
                        আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) এই আহ্বানে সাড়া দিয়েছিলেন। তিনি সুলাইমানকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) বাতাসের উপর আধিপত্য দান করেছিলেন, তাকে সমুদ্র দ্রুত এবং সহজে ভ্রমণ করতে সক্ষম করেছিলেন। সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَامُ</span>) বাতাসকে তার জাহাজ চালাতে এবং যে দিকেই তাকে খুশি করে সেই দিকে পাল তোলার নির্দেশ দিতে পারতেন।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        একদিন, নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) আসকালন দেশে যাত্রা করার জন্য তার সেনাবাহিনীকে একত্রিত করেছিলেন। তার বিভিন্ন ব্যাটালিয়ন ছিল, যার মধ্যে জিন, মানুষ, পাখি এবং সব ধরনের প্রাণী একসাথে মার্চ করছিল। যখন তারা একটি উপত্যকার মধ্য দিয়ে যাচ্ছিল, একজন পর্যবেক্ষক পিঁপড়া দূর থেকে আসা সেনাবাহিনী লক্ষ্য করেছিল। সে অন্যদের সতর্ক করে চিৎকার করে চিৎকার করেছিল, <em>"হে পিঁপড়া, তোমাদের বাসস্থানে প্রবেশ কর যাতে সুলাইমান এবং তার সৈন্যরা তোমাদের চূর্ণ না করে যখন তারা বুঝতে পারে না।"</em> (<a href="https://myislam.org/surah-naml/ayat-18/" className="text-blue-600 dark:text-blue-400">সূরা আন-নামল, আয়াত ১৮</a>)
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) তার সমস্ত বিষয় সম্পর্কে সচেতন ছিলেন, একটি পাখি পর্যন্ত। এর অনুপস্থিতি তাকে উদ্বিগ্ন করেছিল এবং লক্ষ্য করা যায়নি,<br />
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                সবকিছুর একটি ভূমিকা রয়েছে, কিছু ভাষ্যকার বলেছেন যে হুদহুদ পাখি আগে নবী সুলাইমানকে (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) পানি দেখাতে পথনির্দেশ করেছিল। অন্যরা পরামর্শ দিয়েছেন যে এই পাখিগুলি সূর্য থেকে ছায়া প্রদান করেছিল। <strong>যাইহোক, একক পাখির অনুপস্থিতি অনুভূত এবং জানা ছিল।</strong> কিছু নেতা সরাসরি রাগ এবং শাস্তিতে ডিফল্ট করবে, অনুপস্থিতিকে তাদের কর্তৃত্বের জন্য একটি চ্যালেঞ্জ হিসাবে দেখে। কিন্তু নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) শান্ত ছিলেন, তিনি প্রথমে কারণ খুঁজে বের করতে বলেছিলেন।
                            </p>
                        </div>
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
                    ...
                    <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                        <CardContent className="pt-6">
                            ...
                            <p className="text-sm md:text-base leading-relaxed italic">
                                কীভাবে এটি হতে পারে নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) নিজের কাছে ভেবেছিলেন? তার জিন, প্রাণী এবং মানুষের মাধ্যমে তার চোখ এবং কান সর্বত্র ছিল। এটি তার কাছে অবাক করা ছিল যে একটি ছোট পাখি অজানা খবর আনতে পারে। তাই, তিনি মনোযোগ সহকারে শুনেছিলেন যখন পাখিটি অব্যাহত রেখেছিল,<br />
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) বলেছেন যে তাকে ক্ষমতা, কর্তৃত্ব এবং একটি মহান সিংহাসন দেওয়া হয়েছিল। তবুও, তার সাম্রাজ্য নবী সুলাইমানের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) আকার এবং মহত্ত্বের সাথে মিল ছিল না, কিন্তু এটি নিজের অধিকারে উল্লেখযোগ্য ছিল। তার কাছে তার প্রয়োজনীয় সবকিছু ছিল।
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>বার্তাবাহকরা তারপর উপহার নিয়ে বিলকিসের কাছে ফিরে গিয়েছিল এবং তাকে নবী সুলাইমানের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) এবং তার রাজ্যের মহত্ত্বের রিপোর্ট করেছিল।</strong> রানী তার দ্বারা মুগ্ধ হয়েছিলেন এবং সিদ্ধান্ত নিয়েছিলেন যে তিনি তার আমন্ত্রণ গ্রহণ করবেন কিন্তু তার সাথে সরাসরি কথা বলতে চেয়েছিলেন। তিনি তারপর নিজেকে প্রস্তুত করেছিলেন এবং জেরুজালেমে ভ্রমণের জন্য রওনা হয়েছিলেন।
                    </p>
                </section>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) কৌশলগতভাবে তার শক্তি প্রদর্শন করতে চেয়েছিলেন বাস্তবে এটি ব্যবহার করার পরিবর্তে। রানীর ইসলাম গ্রহণের প্রবণতা বোঝার সাথে, তিনি তার বিশ্বাসকে শক্তিশালী করার জন্য একটি অলৌকিক ঘটনা সহজতর করতে চেয়েছিলেন।
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) এই জিনকে উত্তর দেননি। তারপর আরেকটি জিন, যাকে বলা হয়েছিল যে তার কাছে বইয়ের জ্ঞান ছিল, বলেছিল যে সে এর চেয়ে আরও দ্রুত এটি আনতে পারে। নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) চোখের পলক ফেলার আগেই, হুদহুদ পাখি যে মহান সিংহাসনের কথা বলেছিল তা তার সামনে রাখা হয়েছিল।
                            </p>
                        </div>
                        <div className="w-full md:w-1/3 flex-shrink-0">
                            <img 
                ...
                <section className="my-8 md:my-12">
                    ...
                    <p className="mb-4">
                        যখন বিলকিস নবী সুলাইমানের প্রাসাদে পৌঁছেছিল, তাকে একটি অনুষ্ঠানে স্বাগত জানানো হয়েছিল। আগে, নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) তার প্রতিক্রিয়া পরীক্ষা করার জন্য সিংহাসনটি সামান্য ছদ্মবেশ করতে বলেছিলেন।
                    </p>
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <Card className="my-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-l-4 border-amber-500">
                                <CardContent className="pt-6">
                                    ...
                                    <p className="text-sm md:text-base leading-relaxed italic">
                                        এই সহজ মিথস্ক্রিয়া থেকে, সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) দেখে মুগ্ধ হয়েছিলেন যে তিনি তার পদ্ধতিতে খুব কূটনৈতিক ছিলেন।<br /><br />
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 my-6">
                        <div className="flex-1">
                            <p className="mb-4">
                                নবী সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) রানীকে তার প্রাসাদের মধ্য দিয়ে নিয়ে যাওয়ার সময়, তিনি তাকে একটি মহান হলের মধ্যে নিয়ে গিয়েছিলেন যা জিনদের দ্বারা নির্মিত হয়েছিল। মেঝেটি স্বচ্ছ কাচের একটি পুরু স্তর দিয়ে তৈরি করা হয়েছিল, এবং এর নীচে পানি প্রবাহিত হচ্ছিল। মেঝেটিকে পানির একটি পুল হিসাবে ভুল করে, রানী তার পোশাক তুলে ধরেছিলেন এটিকে শুকনো রাখতে। সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) স্পষ্ট করেছিলেন, "নিশ্চয়ই, এটি একটি প্রাসাদ [যার মেঝে] কাচ দিয়ে মসৃণ করা হয়েছে।"<br />
                    ...
                    <p className="mb-4">
                        তার হৃদয়ে, তিনি ইতিমধ্যে ইসলামের দিকে আকৃষ্ট হয়েছিলেন, কিন্তু এই অভিজ্ঞতা তাকে আরও কিছু উপলব্ধি করিয়েছিল - বাহ্যিক চেহারা মানুষের বোঝাপড়াকে প্রতারিত করতে পারে। তিনি সুলাইমানের (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) পাঠ থেকে সংযোগ করতে শুরু করেছিলেন এবং দেখেছিলেন যে তাদের বিশিষ্টতার কারণে সূর্য এবং চাঁদের উপাসনা করা কতটা বোকামি ছিল।
                    </p>
                ...
                <section className="my-8 md:my-12">
                    ...
                    <div className="flex flex-col md:flex-row-reverse gap-4 md:gap-6 my-6">
                        ...
                        <div className="flex-1">
                            <p className="mb-4">
                                <strong><span className="text-amber-600 dark:text-amber-500">আল্লাহর (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) সময় কাছে আসার সাথে সাথে তার বিশ্বস্ত বান্দাকে তার কাছে ফিরিয়ে নেওয়ার জন্য</span>, সুলাইমান (<span className="font-arabic">عَلَيْهِ ٱلسَّلَام</span>) একটি চূড়ান্ত অনুরোধ করেছিলেন।</strong> তিনি জিজ্ঞাসা করেছিলেন যে মৃত্যুর ফেরেশতা তার আত্মা নিতে পারে কিনা যখন তিনি তার লাঠির দ্বারা সমর্থিত, সোজা, বসে ছিলেন। আল্লাহ (<span className="font-arabic">سُبْحَٰنَهُۥ وَتَعَٰلَىٰ</span>) তার অনুরোধ মঞ্জুর করেছিলেন। সুলাইমান (<span className="font-arabic"></span>) জিনদের পরিশ্রম করতে দেখার সময়, ফেরেশতা নিঃশব্দে এসে তার আত্মা নিয়েছিল। তার দেহ সমর্থিত রয়ে গিয়েছিল, এই দুনিয়া থেকে প্রস্থানের কোনো লক্ষণ দেখাচ্ছিল না।
                            </p>
                        </div>
                    </div>
